...
sex, nrRowsg, nrColsg = read_tadpole.load_csv_no_header(gender_file_path)
...
np.savetxt('age_column_train_synthnoteasy.csv', age_column_train, fmt='%s',delimiter=',')
np.savetxt('gender_column_train_synthnoteasy.csv' , gender_column_train, fmt='%s',delimiter=',')
np.savetxt('labels_column_train_synthnoteasy.csv' , labels_train, fmt='%s',delimiter=',')
np.savetxt('age_column_test_synthnoteasy.csv', age_column_test, fmt='%s',delimiter=',')
np.savetxt('gender_column_test_synthnoteasy.csv' , gender_column_test, fmt='%s',delimiter=',')
np.savetxt('labels_column_test_synthnoteasy.csv' , labels_test, fmt='%s',delimiter=',')
np.savetxt('age_column_val_synthnoteasy.csv', age_column_val, fmt='%s',delimiter=',')
np.savetxt('gender_column_val_synthnoteasy.csv' , gender_column_val, fmt='%s',delimiter=',')
np.savetxt('labels_column_val_synthnoteasy.csv' , labels_val, fmt='%s',delimiter=',')
...
gamma, beta, hidden_a, hidden_b, lr =[0.118652722, 0.0911427465, 61, 47, 0.00779604080] #hyperparameters found with RBFOpt
...
np.savetxt('gcn_u_train_emb%i_synthnoteasy_nonorm.csv' %iteration_max_val, gcn_u_train, fmt='%s',delimiter=',')
np.savetxt('gcn_v_train_emb%i_synthnoteasy_nonorm.csv' %iteration_max_val, gcn_v_train, fmt='%s',delimiter=',')
np.savetxt('gcn_u_val_emb%i_synthnoteasy_nonorm.csv' %iteration_max_val, gcn_u_val, fmt='%s',delimiter=',')
np.savetxt('gcn_v_val_emb%i_synthnoteasy_nonorm.csv' %iteration_max_val, gcn_v_val, fmt='%s',delimiter=',')
np.savetxt('gcn_u_test_emb%i_synthnoteasy_nonorm.csv' %iteration_max_val, gcn_u_test, fmt='%s',delimiter=',')
np.savetxt('gcn_v_test_emb%i_synthnoteasy_nonorm.csv' %iteration_max_val, gcn_v_test, fmt='%s',delimiter=',')
