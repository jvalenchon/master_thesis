...
def optimize(x):
    ...
    nb_itera =200
    print(x)
    dropout, lr, l2_regu, ord_row, n_conv_feat=x
...
"""bb=rbfopt.RbfoptUserBlackBox(5, np.array([0.5, 0.0005, 0.000001, 1, 1]), np.array([1.0, 0.05, 0.0001, 5, 100]), np.array(['R', 'R', 'R', 'I', 'I']), optimize)
...
for seed in range(nb_seeds):
    nb_itera =500
    dropout, n_conv_feat, lr, l2_regu,nb_layers, ord_row=0.967, 15, 0.000529, 0.0000309, 2, 1
    n_conv_feat=int(n_conv_feat)
